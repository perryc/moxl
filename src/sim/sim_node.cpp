...
moxl::sim::SimNode::SimNode(const rclcpp::NodeOptions& options) : Node("sim_node", options)
{
...
bool moxl::sim::SimNode::isInDockingStation()
{
...
void moxl::sim::SimNode::chargerPresentSimulationCallback()
{
...
void moxl::sim::SimNode::batteryStateSimulationCallback()
{
...
void moxl::sim::SimNode::dockingStationPoseCallback(geometry_msgs::msg::Pose::SharedPtr msg)
{
